<template lang="">
  <footer aria-labelledby="footer-heading" class="w-full mt-40">
    ...
    <h2 id="footer-heading" class="text-xl font-semibold">CharityComps</h2>
      ...
      <div class="pb-20 pt-8  borderTop w-full xl:gap-8">
        <div class="w-full  grid md:grid-cols-2 gap-x-4 gap-y-16 lg:grid-cols-4 ">
            <div>
      ...
      <div
        class="mx-auto max-w-7xl px-6 py-10 md:flex md:items-center md:justify-between lg:px-8"
      >
        ...
        <p class="text-center text-sm/6 text-gray-400 md:order-1 md:mt-0">
