  ...
  <div class="relative">
   ...
   <Navbar />
    ...
    <main class="relative isolate">
        ...
        <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base/7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-16">
          <div v-for="value in values" :key="value.name" class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <component :is="value.icon" class="absolute top-1 left-1 size-5 text-emerald-500" aria-hidden="true" />
              {{ value.name }}
            </dt>
            {{ ' ' }}
      ...
      <!-- CTA section -->
      <div class="relative isolate -z-10 mt-32 mb-20 sm:mt-40">
        <div
    ...
    >
      ...
      />
        ...
        <div class="mx-auto relative z-[40] max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="w-full flex-auto">
              ...
              <ul role="list" class="mt-10 grid grid-cols-1 gap-x-8 gap-y-3 text-base/7 text-white sm:grid-cols-2">
                <li v-for="benefit in benefits" :key="benefit" class="flex gap-x-3">
                  <CheckCircleIcon class="h-7 text-emerald-500 w-5 flex-none" aria-hidden="true" />
                  {{ benefit }}
                </li>
              </ul>
              <div class="mt-10 flex">
                <a href="#" class="text-sm/6 font-semibold text-emerald-400">See our job postings <span aria-hidden="true">&rarr;</span></a>
              </div>
            </div>
          </div>
        </div>
