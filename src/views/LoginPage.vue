<template>
  <div class="bg-[#101828] relative min-h-screen pt-10  pb-20  px-4 mx-auto">
    ...
    <div class=" max-w-2xl mt-12 w-full h-full relative z-[9999] shadow-md border ring-1 ring-white/20 bg-white/5 text-white backdrop-blur-3xl px-5 py-6 rounded-xl mx-auto">
      <form
        v-if="isRegistering"
        class="mt-6 "
        ...
        <div class="">
          ...
          <div class="flex mt-6 flex-col gap-4">
            ...
            <button
              ...
              type="button"
              class="rounded-md w-fit bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Register
            </button>
